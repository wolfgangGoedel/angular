...
export declare abstract class DynamicComponentLoader {
     ...
     * ```
     */
    abstract loadNextToLocation(type: Type, location: ViewContainerRef, injector?: Injector, projectableNodes?: any[][]): Promise<ComponentRef>;
}
export declare class DynamicComponentLoader_ extends DynamicComponentLoader {
    ...
    loadNextToLocation(type: Type, location: ViewContainerRef, injector?: Injector, projectableNodes?: any[][]): Promise<ComponentRef>;
}
