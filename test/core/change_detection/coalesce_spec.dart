library angular2.test.core.change_detection.coalesce_spec;

import "package:angular2/testing_internal.dart"
    show ddescribe, describe, it, iit, xit, expect, beforeEach, afterEach;
import "package:angular2/src/facade/lang.dart" show isBlank;
import "package:angular2/src/core/change_detection/coalesce.dart" show coalesce;
  ...
  describe("change detection - coalesce", () {
    ...
    it("should replace duplicate terminal records with self records", () {
      ...
      expect(rs[1]).toEqual(new ProtoRecord(RecordType.Self, "self", null, [],
          null, 1, null, 2, null, true, false, false, false, 0));
    });
    ...
    describe("short-circuit", () {
      it("should not use short-circuitable records", () {
        var records = [
          r("sknot", [], 0, 1,
              mode: RecordType.SkipRecordsIfNot, fixedArgs: [3]),
          r("a", [], 0, 2),
      ...
      it("should not use short-circuitable records from nested short-circuits",
        ...
        var records = [
          r("sknot outer", [], 0, 1,
              mode: RecordType.SkipRecordsIfNot, fixedArgs: [7]),
          r("sknot inner", [], 0, 2,
              mode: RecordType.SkipRecordsIfNot, fixedArgs: [4]),
          r("a", [], 0, 3),
      ...
      it("should collapse the false branch", () {
        var rs = coalesce([
          r("a", [], 0, 1),
          r("sknot", [], 0, 2,
              mode: RecordType.SkipRecordsIfNot, fixedArgs: [5]),
          r("a", [], 0, 3),
          r("b", [], 3, 4),
      ...
      it("should optimize skips", () {
        var rs = coalesce([
          ...
          r("sknot", [], 0, 1,
              mode: RecordType.SkipRecordsIfNot, fixedArgs: [2]),
